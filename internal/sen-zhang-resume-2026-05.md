...
- **Computational BIM Developer — sole developer of every plugin and SaaS tool in Ennead's Design Technology stack (160-person firm), while also performing BIM manager duties on active projects. Platform development, BIM management, complex-geometry triage.**
  - Developer of EnneadTab — 450+ tools across Revit, Rhino, CAD, Adobe, Excel, Email, and LLM integration; three U.S. Copyright registrations (2024)
  - Developer of 8+ additional production web services and Revit/Rhino plugins — see Selected Projects below
...
_Note on visuals — the EnneadTab product family and the internal Ennead-owned tools below are Ennead IP and cannot be shown in a public résumé. A live walkthrough with client and firm-internal details redacted is available during interview._
...
Native Android self-guidance app for social-media consumption — strips Reels/Shorts/algorithmic feeds from Instagram, YouTube, Facebook, and X via WebView CSS/JS injection, returning user agency over feed time. Native Android (Kotlin / Jetpack Compose). Pre-launch.
...
Early-stage venture pairing a customer-facing web app with an agent-team that runs daily small-business operations end-to-end. In build phase.
